...
router.get("/detail/:exhibitId", exhibitsController.getdetailExhibit); //전시 상세 추가
router.get("/categoryList", exhibitsController.getCategoryList); //카테고리 리스트
router.get("/categories/:categoryId", exhibitsController.getExhibitByCategory); //카테고리별 전시 리스트
