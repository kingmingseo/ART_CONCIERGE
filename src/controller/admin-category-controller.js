...
async function putCategory(req, res, next) {
    try{
        ...
        const newcategory = await a_categoryService.updateCategory(categoryId, { category });
...
async function deleteCategory(req, res, next) {
    try{
        ...
        const newcategory = await a_categoryService.deleteCategory(categoryId, { category });
        res.json(newcategory);
